...
export default function Insights() {
  ...
  return (
    <section id="insights" className="py-16 sm:py-20 bg-[#0a0a0a]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {insights.map((i) => (
            <div key={i.metric} className="rounded-2xl border border-white/10 bg-white/[0.03] p-5 shadow-[0_0_0_1px_rgba(255,255,255,0.04)]">
              <div className="flex items-center justify-between">
